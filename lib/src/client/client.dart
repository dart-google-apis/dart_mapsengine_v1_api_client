...
abstract class Client extends ClientBase {
  core.String basePath = "/mapsengine/v1/";
  ...
  AssetsResource_ get assets => new AssetsResource_(this);
  LayersResource_ get layers => new LayersResource_(this);
  MapsResource_ get maps => new MapsResource_(this);
  ProjectsResource_ get projects => new ProjectsResource_(this);
  RasterCollectionsResource_ get rasterCollections => new RasterCollectionsResource_(this);
  RastersResource_ get rasters => new RastersResource_(this);
  TablesResource_ get tables => new TablesResource_(this);
